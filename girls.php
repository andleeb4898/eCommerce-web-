...
$result = mysqli_query(
$conn,
"SELECT * FROM `catogaries` WHERE `code`='$code'"
);
...
if(empty($_SESSION["shopping_cart"])) {
	...
	$status = "<div class='box' style='color:darkblue;'>
...
<!--end of cart icon-->           
                             ...
                             <div class="carousel-item active">
                                  <img src="images/Pret_d173a797-9230-4b41-b359-8e23128a7d2e.webp" class="d-block w-100" alt="..."  >
                                        </div>
...
<?php 
$result = mysqli_query($conn,"SELECT * FROM `catogaries`");
