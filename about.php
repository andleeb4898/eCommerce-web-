            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">  
                        ...
                        <p>A brand is the set of expectations, memories, stories and relationships that, taken together, account for a consumer’s decision to choose one product or service over another.</p>
                        <p>Customer satisfaction is our first priority.</p>
                    <p>A high-street brand introduced by one of the largest names in the textile industry, Fusion is celebrated for combining 100% pure fabric with unprecedented design aesthetics to create designer wear at an affordable price.</p>
        </div>
                </div>
            </div>
        </main>
